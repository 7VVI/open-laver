        ...
        <div className="flex items-center justify-between mb-1">
          ...
          <div className="flex items-center gap-2">
            ...
            <button
              ...
              className="text-sm bg-[#333333] hover:bg-[#111111] text-white rounded-lg px-3 py-1.5"
            >
              + 添加模型
            </button>
          </div>
          ...
          {models.map((m) => (
            <div
              ...
              className={`rounded-xl border p-4 ${
                m.active ? "border-[#34c759] bg-[#f0fdf4]" : "border-slate-200 bg-white"
              }`}
            >
              <div className="flex items-start justify-between gap-3">
                <div className="min-w-0">
                  <div className="flex items-center gap-2">
                    ...
                    {m.active && (
                      <span className="text-[10px] bg-[#34c759] text-white rounded px-1.5 py-0.5">
                        当前使用
                      </span>
                    )}
                    {!m.has_key && (
